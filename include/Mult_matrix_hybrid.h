...
class Mult_matrix_hybrid {
    private:
        ...
        int n0;                                         // Cota minima de tamaño para usar  el algoritmo clásico.
    public:
        ...
        /**
         * @brief Algoritmo Hibrido Strassen-Clásico
         * 
         * La idea es usar Strassen junto a el algoritmo clásico dependiendo del tamaño de las submatrices.
         * 
         * @param A Matriz A.
         * @param B Matriz B.
